...
Route.get('/profiles/:profileId/education', 'EducationController.index').middleware('auth')
Route.post('/profiles/:profileId/education', 'EducationController.store')
  .middleware('auth')
  .middleware('verification')
Route.patch('/profiles/:profileId/education/:contactId', 'EducationController.update')
  .middleware('auth')
  .middleware('verification')
Route.delete('/profiles/:profileId/education/:contactId', 'EducationController.destroy')
  .middleware('auth')
  .middleware('verification')
