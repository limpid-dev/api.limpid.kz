...
Route.post('/profiles/:profileId/education', 'EducationsController.store')
  .middleware('auth')
  .middleware('verification')
Route.patch('/profiles/:profileId/education/:contactId', 'EducationsController.update')
  .middleware('auth')
  .middleware('verification')
Route.delete('/profiles/:profileId/education/:contactId', 'EducationsController.destroy')
  .middleware('auth')
  .middleware('verification')
