...
Route.get('/profiles/:profileId/education', 'EducationsController.index').middleware('auth')
Route.post('/profiles/:profileId/education', 'EducationsController.store')
  .middleware('auth')
  .middleware('verification')
Route.patch('/profiles/:profileId/education/:educationId', 'EducationsController.update')
  .middleware('auth')
  .middleware('verification')
Route.delete('/profiles/:profileId/education/:educationId', 'EducationsController.destroy')
  .middleware('auth')
  .middleware('verification')
